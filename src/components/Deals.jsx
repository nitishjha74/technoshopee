    ...
    <section className="deals-section">
      ...
      <div className="deals-grid">
        ...
        <div className="deal-card">
          ...
          <img src="/images/gpp.webp" alt="Product" />
          <h3>Google Pixel 8A 8GB 128GB</h3>
          <p className="price">
            ₹28,454 <span className="old-price">₹49,999</span>
          </p>
        ...
        <div className="deal-card">
          ...
          <img src="/images/sa35.jpeg" alt="Product" />
          <h3>Samsung A35 5G 8GB 256GB</h3>
          <p className="price">
            ₹22,279 <span className="old-price">₹33,999</span>
          </p>
          <button className="add-btn">+ Add to Cart</button>
        </div>
        ...
        <div className="deal-card">
          ...
          <img src="/images/iphone1.jpeg" alt="Product" />
          <h3>Apple iPhone 15 128GB</h3>
          <p className="price">
            ₹52,999 <span className="old-price">₹69,900</span>
          </p>
          <button className="add-btn">+ Add to Cart</button>
        </div>
        ...
        <div className="deal-card">
          <span className="discount-tag">22% off</span>
          <img src="/images/gog.jpeg" alt="Product" />
          <h3>Google Pixel 9a 8GB 256GB</h3>
          <p className="price">
            ₹39,061 <span className="old-price">₹49,999</span>
          </p>
          <button className="add-btn">+ Add to Cart</button>
        </div>
